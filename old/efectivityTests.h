...
/*
 * iterations número de repetições do experimento
 * data_length_ tamanho dos dados (em bytes)
*/
uint16_t periodicBurstTest(uint16_t nIter, uint16_t pLen){
	//T representa o tamanho do treshold e N é o burst length descrito na seção 4 do trabalho de Sousa & Ferreira (2007)
